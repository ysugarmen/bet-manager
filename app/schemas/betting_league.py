...
class BettingLeagueBase(BaseModel):
    ...
    group_picture: Optional[str] = Field(None, description="The group picture of the league")
...
class BettingLeagueResponse(BettingLeagueBase):
    ...
    num_members: Optional[int] = Field(None, description="The number of members in the league")
