from sqlalchemy import Column, Integer, String, DateTime, JSON, ForeignKey, Boolean, func, Text
...
class BettingLeague(Base):
    ...
    def generate_code(self, db: Session):
        ...
        while True:
            ...
            if not db.query(BettingLeague).filter(BettingLeague.code == league_code).first():
