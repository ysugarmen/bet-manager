...
class Settings(BaseSettings):
    ...
    CL_GAMES_SCRAPING_URL: str = os.getenv("CL_GAMES_SCRAPING_URL", "https://fbref.com/en/comps/8/schedule/Champions-League-Scores-and-Fixtures")
    ...
    LOGO_BASE_PATH : str = "/Users/yonatansugarmen/Desktop/Projects/Apps/BetManager/static/team_logos/"
    GAME_STANSDART_LENGTH : int = 3
    BETTING_ODDS_API_URL : str = "https://api.the-odds-api.com/v4/sports/soccer_uefa_champs_league/odds/"
    BETTING_ODDS_API_KEY : str = os.getenv("BETTING_ODDS_API_KEY", "924657fcf70ca731200be32d4656b10a")
