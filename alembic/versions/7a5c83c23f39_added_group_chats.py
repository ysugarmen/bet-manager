...
def upgrade() -> None:
    ...
    op.drop_table('posts')
    op.add_column('betting_leagues', sa.Column('chat_messages', sa.JSON(), nullable=True))
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['league_id'], ['betting_leagues.id'], name='posts_league_id_fkey'),
